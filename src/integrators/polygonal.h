 ...
 */
	...
	v3f renderAnalytic(const Ray& ray, Sampler& sampler) const {
		...
		// 2. if there's intersection i, loop through the tirangle vector and compute Equation (3). 
		//	Sum up the contribution of each triangle edge. 
		// 3. retrieve albedo at the surface point. compute incident radiance
		// 4. compute and return the diffuse outgoing radance at i.
